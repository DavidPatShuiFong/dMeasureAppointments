...
sms_tags <- shiny::HTML(
  ...
  "<tr><td><code>%Firstname%</code></td> <td>First name of patient</td></tr>",
  "<tr><td><code>%Surname%</code></td> <td>Surname of patient</td></tr>",
  "<tr><td><code>%Preferredname%</code></td> <td>Preferred name of patient</td></tr>",
